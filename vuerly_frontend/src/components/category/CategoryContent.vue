<template>
    <div class="best-content">
      ...
      <div class="best-card">
        <div class="card-list" v-for="(rowData, idx) in paginatedData" :key="idx" @click="goDetail(rowData.num)">
          <div class="img-wrap">
  ...
  export default {
    ...
    methods: {
      ...
      callaxios() {
        axios
          .get(
            "/product/getCateProduct?category="
              + this.category
              + "&sort="
              + this.sort
              + "&brand_num="
    ...
    created() {
      ...
      axios
        .get("/product/getCateProduct?category="
            + this.category
            + "&sort="
            + this.sort
        )
