  ...
  <div class="best-content">
    <div class="best-content-filter">
      ...
      <ul class="content-filter">
        <li @click="recentsort" class="checksort">신상품순</li>
...
export default {
  ...
  methods: {
    ...
    recentsort() {
      // order 조건 지우고 추가
      this.sort =
        this.sort.substring(0, this.sort.indexOf("order")) + "num_desc";
      this.callaxios();
    ...
    popularsort() {
      this.sort =
        this.sort.substring(0, this.sort.indexOf("order")) + "readcount_desc";
      this.callaxios();
      this.changecolor(event);
    },
    // 낮은가격순
    lowcostsort() {
      this.sort =
        this.sort.substring(0, this.sort.indexOf("order")) + "price_asc";
      this.callaxios();
      this.changecolor(event);
    },
    // 높은가격순
    highcostsort() {
      this.sort =
        this.sort.substring(0, this.sort.indexOf("order")) + "price_desc";
      this.callaxios();
      this.changecolor(event);
    },
    //props이벤트
  ...
  created() {
    axios
      .get(
        //HOST +
        "/product/getAllProduct?sort=" + this.sort
      )
      .then((response) => {
